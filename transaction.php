            ...
            <form action="sell.php" method="post">
                ...
                <tr><td style="vertical-align:top; padding:10px; width:40%">
                    <table style="margin-left:auto; margin-right:auto">
                        ...
                        <tr><td colspan="2" style="float:right"><input class="waves-effect waves-light btn" value="ADD" onClick="transadd()" id="add" type="button" /></td></tr>
                ...
                <tr><td><button class="waves-effect waves-light btn" type="submit" name="submit" onclick="validate()" value="Pay and Print"/>Pay and Print</form></td><td>
